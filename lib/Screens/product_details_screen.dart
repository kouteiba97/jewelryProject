                    ...
                    child: ListTile(
                      title: Row(
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            child: Text(
                              'DA ${widget.product_details_price}',
                              style: kNumberTextStyle,
                            ),
                          ),
                          Expanded(
                            child: Text(
                              'DA ${widget.product_details_oldPrice}',
                          ...
                          showDialog(
                              ...
                              builder: (context) {
                                return AlertDialog(
                                  title: Text('Size'),
                                  content: Text(
                                      'Here we can select the size of items'),
                                  actions: <Widget>[
                                    TextButton(
                                      onPressed: () {},
                                      child: Text('Confirm'),
                    ...
                    Expanded(
                      child: MaterialButton(
                        ...
                        child: Text(
                          'Buy now',
                          style:
                              kCategoryTextStyle.copyWith(color: Colors.white),
                        ),
                      ),
                    ),
                    IconButtons(
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: kCategoryTextStyle.copyWith(
                                color: Colors.grey[900], fontSize: 17.0),
                          ),
                        ),
                        Padding(
                          padding: EdgeInsets.fromLTRB(15.0, 12.0, 5.0, 5.0),
